...
const variants: Record<ButtonVariant, string> = {
  ...
  secondary: "bg-secondary text-secondary-foreground shadow-sm hover:-translate-y-px hover:bg-secondary/88",
  outline: "border border-border/80 bg-background/92 shadow-sm hover:-translate-y-px hover:bg-secondary/80",
