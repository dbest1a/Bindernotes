...
import type {
  WhiteboardModuleContextKind,
  WhiteboardModuleDefinition,
        ...
        {controlsCollapsed ? (
          ...
          <div className="whiteboard-control-panel pointer-events-auto grid w-[min(17rem,calc(100vw-2rem))] gap-2 rounded-lg border p-2 text-xs">
            ...
            <label className="grid gap-1">
              <span className="whiteboard-control-panel__label text-[10px] font-semibold uppercase tracking-[0.16em]">
                Board name
              </span>
              <input
