...
export function usePerformanceMode() {
  ...
  return useMemo(
    () => ({
      ...
      setPerformanceModeEnabled: (enabled: boolean) => setEnhancedModeEnabled(!enabled),
    }),
    [effectivePerformanceMode, preference.enabled, prefersReducedMotion, setEnhancedModeEnabled],
  );
}
