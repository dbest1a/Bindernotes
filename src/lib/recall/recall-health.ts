...
import type { RecallCard, RecallHealthSummary, RecallSessionSummary } from "@/lib/recall/recall-types";
...
export function summarizeRecallHealth(
  ...
  return {
    ...
    sourceGaps: cards.filter((card) => card.status === "Source gap" || card.qualityStatus === "source_gap")
      .length,
