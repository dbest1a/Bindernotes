...
export const mathSeedCourses: MathCourse[] = [
  ...
  },
  {
    ...
    slug: "calculus-1",
    title: "Calculus 1",
    description: "Starter module on derivatives as slopes. Full Calculus 1 coverage is not included.",
    order_index: 3,
    created_at: SEED_TIME,
    updated_at: SEED_TIME,
  },
  {
    ...
    slug: "calculus-2",
    title: "Calculus 2",
    description: "Starter Taylor polynomial explorer. Full Calculus 2 coverage is not included.",
    order_index: 4,
    created_at: SEED_TIME,
    updated_at: SEED_TIME,
  },
  {
    ...
    slug: "calculus-3",
    title: "Calculus 3",
    description: "Starter surface and tangent plane explorer. Full Calculus 3 coverage is not included.",
    order_index: 5,
    created_at: SEED_TIME,
    updated_at: SEED_TIME,
  },
...
export const mathSeedQuestions: QuestionBankItem[] = [
  ...
  question({
    ...
    prompt: "Why can a finite Taylor approximation become less accurate farther from x=0?",
