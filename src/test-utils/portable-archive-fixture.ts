...
export function archiveFixture(): PortableArchive {
  ...
  const folder = "20000000-0000-4000-8000-000000000001",
    binder = "20000000-0000-4000-8000-000000000002",
    note = "20000000-0000-4000-8000-000000000003";
  const content = {
    type: "doc",
    content: [
      {
        type: "paragraph",
        content: [
          { type: "text", text: "Exact prose and λ remain unchanged" },
          {
            type: "sourceMarker",
            attrs: { binderId: "source", lessonId: "lesson", sourceUrl: "/binders/source/documents/lesson" },
          },
        ],
      },
    ],
  ...
  return portableArchiveSchema.parse({
    ...
    tables: {
      personal_note_folders: [
        { ...metadata, id: folder, name: "Folder", color: "teal", sort_order: 0, archived_at: null },
      ],
      ...
      personal_notes: [
        {
          ...
          title: "My note",
          content,
          math_blocks: [{ id: "equation", type: "latex", latex: "x^2 + λ = 1" }],
          tags: ["exam"],
          pinned: true,
          folder_id: folder,
          binder_id: binder,
